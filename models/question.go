...
func createQuestionCategories(ctx context.Context, requestCategories []*pb.CreateQuestionRequest_Category, db *gorm.DB, question Question) {
...
func createAnswerCategories(ctx context.Context, requestCategories []*pb.CreateQuestionRequest_Answer_Category, db *gorm.DB, answer Answer) {
	categories = categories[:0]
