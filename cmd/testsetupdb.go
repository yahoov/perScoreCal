...
var testsetupdbCmd = &cobra.Command{
	Use:   "testsetupdb",
	Short: "Setup DB",
	Long:  `Create and migrate schema for testdatabase`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("test setupdb called")
		db, err := gorm.Open("postgres", "host=localhost user=testperscorecal dbname=test_per_score_cal sslmode=disable password=testperscorecal-dm")
		defer db.Close()
		if err != nil {
...
func init() {
	RootCmd.AddCommand(testsetupdbCmd)
